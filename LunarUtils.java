package com.pindian.birthalert;
...
public class LunarUtils {
     ...
     */
    public int[] lunarToSolar(int year, int month, int monthDay)
    {
        int dayOffset;
        int leapMonth;
        int i;
     ...
     * @param //查询区间 1900年正月初一 至 2099年腊月三十
     */
    public String getTranslateSolarString(int year, int month, int monthDay)
    {
        String result = "";
     ...
     * @param //查询区间 1900-01-31 至 2100-02-08
     */
    public String getTranslateLunarString(int year, int month, int monthDay)
    {
        String result = "";
     ...
     */
    public int daysInLunarYear(int year)
    {
     ...
     * @return 若返回null表示参数错误
     */
    public String getLunarDayName(int day)
    {
        String res = "";
     ...
     * 月份为按13个月的位置
     */
    private int daysInMyMonth(int year, int pos)
    {
        if ((LUNAR_INFO[year - MIN_YEAR] & (0x100000 >> pos)) == 0)
            return 29;
        else
